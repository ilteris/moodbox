import processing.core.*; import processing.core.PApplet; import processing.core.PFont; import processing.core.PImage; import processing.opengl.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; 
...
public class moodboox extends PApplet {
	...
	public void setup() {
		...
		for(int i =0; i < s.length; i++) {
		 ...
		 php = new ThreadPHP(this, 10000, s, t);  // new thread every N milliseconds
